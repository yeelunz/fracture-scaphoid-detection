...
class ResNet50RotatedBBoxNet_5d(nn.Module):
    # resnet101
    # resnet152
    def __init__(self, backbone='resnet101', fpn_channels=256, reg_dropout_p=0.3, cls_dropout_p1=0.3, cls_dropout_p2=0.2):
        super().__init__()
